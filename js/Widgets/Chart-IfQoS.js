/*
SNMD - Simple Network Management Dashboard
...
define(["snmd-core/js/SVGWidget", "snmd-core/js/SVGImpl/Chart", "snmd-widgets-nagios/js/Utils", "js-logger"], function (SVGWidget, SVGImplChart, Utils, Logger) {
    ...
    var ChartIfQoS = function (root, svg, desc) {
        this.opts = {
            title: "Interface QoS Class",
            axis: [
                {
                    max: 200 * 1000000,
                    scale: 'linear'
            ...
            lcls: ['snmd-lcl-Nag', 'snmd-lcl-NagIf', 'snmd-lcl-NagIfQoS'],     /* line classes    */
            mcls: ['snmd-mcl-Nag', 'snmd-mcl-NagIf', 'snmd-mcl-NagIfQoS'],     /* maxline classes */
            tcls: ['snmd-tcl-Nag', 'snmd-tcl-NagIf', 'snmd-tcl-NagIfQoS']      /* text classes    */
        };
    ...
    ChartIfQoS.prototype.handleUpdate = function (topic, msg) {
        ...
        try {
            ...
            Logger.debug('[Nagios/Chart-IfQoS] JSON error in performance data: ' + err.message);
            return;
        }
        ...
        for (i = 0; i < this.lines.length; i++) {
            ...
            try {
                ...
                Logger.debug("[Nagios/Chart-IfQoS] Error processing state data: " + err_state.message);
            }
        }
